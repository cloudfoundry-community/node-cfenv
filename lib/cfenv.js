...
(function() {
  ...
  getPort = function(appEnv) {
    var e, port, portString, _ref;
    portString = process.env.PORT || process.env.CF_INSTANCE_PORT || process.env.VCAP_APP_PORT || (appEnv != null ? (_ref = appEnv.app) != null ? _ref.port : void 0 : void 0);
    if (portString == null) {
      if (appEnv.name == null) {
        return 3000;
      }
