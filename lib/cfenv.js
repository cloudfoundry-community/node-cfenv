...
(function() {
  ...
  AppEnv = (function() {
    ...
    AppEnv.prototype.getServiceByLabel = function(spec) {
      var label, matches, service, services;
      if (_.isRegExp(spec)) {
        matches = function(label) {
          return label.match(spec);
        };
      } else {
        spec = "" + spec;
        matches = function(label) {
    ...
    AppEnv.prototype.getServiceCredsByLabel = function(spec) {
      var service;
      service = this.getServiceByLabel(spec);
      if (service == null) {
        return null;
      }
      return service.credentials || {};
